  ...
  return (
    <div className="relative flex gap-1.5 md:gap-2">
      ...
      <button
        ...
        className={`flex items-center gap-1.5 md:gap-2 px-4 md:px-6 py-2.5 md:py-3 rounded-xl md:rounded-2xl font-black text-[9px] md:text-xs uppercase tracking-widest shadow-xl transition-all active:scale-95 ${
          isProcessing ? 'bg-indigo-100 text-indigo-400 cursor-not-allowed shadow-none' : 'bg-indigo-600 text-white hover:bg-indigo-700'
        }`}
      >
      ...
      <button
        ...
        disabled={isProcessing}
        className="p-2.5 md:p-3 bg-white border border-slate-200 rounded-xl md:rounded-2xl text-slate-400 hover:text-indigo-600 hover:border-indigo-200 transition-all shadow-sm"
        title="Upload Image"
      >
